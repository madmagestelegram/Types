...
abstract class Client {
    ...
    )
    {
        ...
        return $this->_apiCall('verifyUser', $requestParameters);
    }
    ...
    )
    {
        ...
        return $this->_apiCall('verifyChat', $requestParameters);
    }
    ...
    )
    {
        ...
        return $this->_apiCall('removeUserVerification', $requestParameters);
    }
    ...
    )
    {
        ...
        return $this->_apiCall('removeChatVerification', $requestParameters);
    }
